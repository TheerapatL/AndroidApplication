...
public class MyDragdrop extends Activity implements View.OnClickListener,
    ...
    public boolean onDrag(View v, DragEvent event){
        switch (event.getAction()){
            ...
            case DragEvent.ACTION_DRAG_ENDED:
                if(event.getResult()){
                    Toast.makeText(MyDragdrop.this,"Awesome!",
                            Toast.LENGTH_SHORT).show();
                    score++;
                }else{
                    Toast.makeText(MyDragdrop.this,"Aw Snap! Try dropping it again",
